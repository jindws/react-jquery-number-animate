...
class Main extends Component {
  ...
  componentWillReceiveProps(newprop) {
    if (newprop.end === this.state.end || this.state.lazy) return;
    this.animate(false);
    this.setState(
      (prevState) => ({ end: newprop.end }),
      () => this.animate()
    );
  }
      ...
      .animate(
        ...
        },
        {
          ...
          step: (re) => {
            ...
            let num = format ? this.format_number(nu) : nu;
  ...
  render() {
    ...
    return (
      <re.type ref="rnum" id={this.props.id} className={this.props.className}>
        {this.state.num}
      </re.type>
    );
  }
