...
var Main = function (_Component) {
  ...
  Main.prototype.animate = function animate() {
    ...
    (0, _jquery2.default)(this).attr('nums', start).animate({
      nums: end
    }, {
      duration: duration,
      easing: easing,
...
_react.Component.propTypes = {
  aa: _propTypes2.default.number,
  sets: _propTypes2.default.shape({
    start: _propTypes2.default.number,
    duration: _propTypes2.default.number,
    end: _propTypes2.default.number,
    easing: _propTypes2.default.oneOf(['easing', 'linear']),
